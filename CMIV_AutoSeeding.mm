...
//	
//	NSMutableDictionary* dic=[parent dataOfWizard];
//	[dic setObject:@"Step1" forKey:@"Step"];
...
- (void)saveCurrentSeeds: (unsigned short*)seedData :(int)size
{
	...
	[seedsnamearray addObject:@"Aorta"];
	[seedsnamearray addObject:@"barrier"];
	[seedsnamearray addObject:@"other"];
	[seedsnamearray addObject:@"other"];
	[seedsnamearray addObject:@"other"];
...
- (void) saveCenterlinesToPatientCoordinate:(NSArray*)centerlines
                                           :(NSArray*)centerlinesNameList
{
...
- (void) useSeedDataToInitializeDirectionData:(unsigned short*)seedData
                                             :(float*)inputData
                                             :(float*)outputData
...
-(int)createCoronaryVesselnessMap:(ViewerController *) vc
                                 :(CMIV_CTA_TOOLS*) owner
                                 :(float)startscale
                                 :(float)endscale
                                 :(float)scalestep
