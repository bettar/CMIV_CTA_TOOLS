...
// QuickTime is deprecated on 64-bit macOS. Import it only for 32-bit builds guarded by the
// following #if !__LP64__ section later in this file.
// #import <QuickTime/QuickTime.h> -- moved into the 32-bit guard below
