...
- (IBAction)createSkeleton:(id)sender
{
	...
	for(i=0;i<[centerlinesList count];i++)
	{
		...
		[centerlinesNameList insertObject:@"dungv" atIndex:i];
		...
		i++;
		[centerlinesList insertObject:apath atIndex:i];
		[centerlinesNameList insertObject:@"dungi" atIndex:i];
		...
		[centerlinesNameList insertObject:@"refinedv" atIndex:i];
		...
		//i++;
		//[centerlinesList insertObject:anewline atIndex:i];
		//[centerlinesNameList insertObject:@"refinedvvvv" atIndex:i];
